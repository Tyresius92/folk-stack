...
```
npx create-remix@latest --template Tyresius92/folk-stack
```
...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create folk-stack-template
  fly apps create folk-stack-template-staging
  ```

  > **Note:** Once you've successfully created an app, double-check the `fly.toml` file to ensure that the `app` key is the name of the production app you created. This Stack [automatically appends a unique suffix at init](https://github.com/remix-run/folk-stack/blob/4c2f1af416b539187beb8126dd16f6bc38f47639/remix.init/index.js#L29) which may not match the apps you created on Fly. You will likely see [404 errors in your Github Actions CI logs](https://community.fly.io/t/404-failure-with-deployment-with-remix-blues-stack/4526/3) if you have this mismatch.
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  >
  > ```
  > WARN app flag 'folk-stack-template-staging' does not match app name in config file 'folk-stack-template'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  fly postgres attach --app folk-stack-template folk-stack-template-db

  fly postgres create --name folk-stack-template-staging-db
  fly postgres attach --app folk-stack-template-staging folk-stack-template-staging-db
  ```
